...
class FeatureOperator {
   ...
   */
  _initStyle(zindex) {
    const ft_style = StyleFactory.createFTStyle(this.getType(), this.feature);
  ...
  setStyle(json_style) {
    ...
    if (this.getType() == "mete_warm_front" || this.getType() == "mete_cold_front" || this.getType() == "mete_occluded_front" || this.getType() == "mete_stationary_front") {
